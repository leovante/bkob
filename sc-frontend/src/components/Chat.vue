...
//       this.stompClient.send("/app/chat.addUser", {}, this.JSON.stringify({sender: username, type: 'JOIN'})
//       );
...
//         this.stompClient.send("/app/chat.sendMessage", {}, this.JSON.stringify(chatMessage));
...
//       var message = this.JSON.parse(payload.body);

//       var messageElement = this.document.createElement('li');
